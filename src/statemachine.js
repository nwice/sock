...
const conor = 'https://api.thegraph.com/subgraphs/name/dasconnor/pangolin-dex'
const conor_old = 'https://graph-node.avax.network/subgraphs/name/dasconnor/pangolindex'
...
if ( process.argv.length > 2 ) {
    dexprices(dexes).then(res => {
        //console.log('yts:', dexes.yts.pairs.map(pair => { return pairnick(pair) + ' ' + pairprice(pair) }) )
    })
}
