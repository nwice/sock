...
common_addr = {
    ...
    '0xa684ef88136a415ed987c0b39bc528a16b3e83b511c414590bbe613f38f1a072', 'unknown'
}
...
known_addr = {}
for d in [recognized_addr, static_addr, common_addr, defi_addr, defi_addr_png, defi_addr_olive, defi_addr_bamboo, nft_addr]:
    for k in d:
        if len(k) == 42:
