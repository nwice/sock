...
aws cloudfront create-invalidation --distribution-id E11ZCATVMKXF7D --paths "/tvl.json" "/assets/site.css" "/common.js" "/tvl" "/total_value_locked.json" "/tvl/snob.json"
aws cloudfront create-invalidation --distribution-id E1JZNMX0HG4856 --paths "/tvl.json" "/assets/site.css" "/common.js" "/tvl" "/total_value_locked.json" "/tvl/snob.json"
aws cloudfront create-invalidation --distribution-id E94H37WVV1OQY --paths "/tvl.json" "/assets/site.css" "/common.js" "/tvl" "/total_value_locked.json" "/tvl/snob.json"
