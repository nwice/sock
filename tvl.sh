...
aws cloudfront create-invalidation --distribution-id E1JZNMX0HG4856 --paths "/tvl" "/tvl/*.json" "/snob/tvl"
aws cloudfront create-invalidation --distribution-id E94H37WVV1OQY --paths "/tvl"  "/tvl/*.json"
